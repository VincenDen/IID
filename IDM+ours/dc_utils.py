...
from dc_networks import MLP, ConvNet, ConvNet_6, ConvNet_Adv, ConvNet_BSR, ConvNet_GBN, ConvNet_Pooling, ConvNet_fc, LeNet, AlexNet, AlexNetBN, VGG11, VGG11BN, ResNet18, ResNet18BN_AP, ResNet18BN, ViTCIFAR
...
def get_eval_pool(eval_mode, model, model_eval):
    if eval_mode == 'M': # multiple architectures
        model_eval_pool = [ 'ConvNet', 'LeNet', 'AlexNet', 'VGG11', 'ResNet18']
        # model_eval_pool = ["ViTCIFAR",'ConvNet']
