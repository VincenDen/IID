    ...
    for exp in range(args.num_exp):
        ...
        for it in range(args.Iteration+1):
            ...
            if it == args.Iteration: # only record the final results
                ...
                torch.save({'data': data_save, 'accs_all_exps': accs_all_exps, }, os.path.join(args.save_path, 'res_%s_%s_%s_%dipc_ori.pt'%(args.method, args.dataset, args.model, args.ipc)))
